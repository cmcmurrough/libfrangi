...
void frangi2d(const cv::Mat &src, cv::Mat &maxVals, cv::Mat &whatScale, cv::Mat &outAngles, bool blackWhite=DEFAULT_BLACKWHITE, int sigma_start=DEFAULT_SIGMA_START, int sigma_end=DEFAULT_SIGMA_END, int sigma_step=DEFAULT_SIGMA_STEP, float beta1=DEFAULT_BETA_ONE, float beta2=DEFAULT_BETA_TWO);
...
void frangi2d(const Mat &src, Mat &maxVals, Mat &whatScale, Mat &outAngles, bool blackWhite, float sigma_start, float sigma_end, float sigma_step, float beta1, float beta2);
...
void frangi2d(const cv::Mat &src, cv::Mat &maxVals, cv::Mat &whatScale, cv::Mat &outAngles, bool blackWhite, int sigma_start, int sigma_end, int sigma_step, float beta1, float beta2)
{
    vector<Mat> ALLfiltered;
    vector<Mat> ALLangles;
